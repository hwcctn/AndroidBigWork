...
class TweetViewModel() : ViewModel() {
    ...
    fun connectWebSocket(context: Context) {
        WebsocketConnection.initialize(context, client, _tweets)
    }
...
////        if (WebsocketConnection.webSocket?.isInitialized) {
////            WebsocketConnection.webSocket?.close(1000, "ViewModel cleared")
////        }
//        WebsocketConnection.
//    }
//
